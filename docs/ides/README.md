...
**Quick install:** run `npx ai-dev-toolkit` from your project root.
...
Shared setup (customize `reference.md` before coding): [README — Shared setup](../../README.md#shared-setup).
